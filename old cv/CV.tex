...
\begin{etaremune}
			...
			\begin{itemize}[nosep]
			\item[] Coverage: \href{https://www.washingtonpost.com/news/monkey-cage/wp/2019/01/31/heres-what-gavin-newsom-elizabeth-warren-and-microsoft-should-know-if-want-to-end-the-affordable-housing-crisis/?tid=sm_tw_cage}{\textit{The Washington Post}},  Ideas of India \href{https://www.discoursemagazine.com/politics/2020/12/24/ideas-of-india-how-does-subsidizing-housing-prices-shape-political-behavior}{Podcast}, \href{https://www.phenomenalworld.org/sources/original-and-forgery/}{Phenomenal World} by the Jain Family Institute, the \href{https://www.comparativepoliticsnewsletter.org/wp-content/uploads/2020/05/Spring-Newsletter-2020.pdf}{\textit{APSA Comparative Politics Newsletter}}, and the \href{https://jop.blogs.uni-hamburg.de/home-price-subsidies-increase-local-level-political-participation-in-urban-india/}{JOP Blog}  			\end{itemize}
			\item Haas, N., Haenschen K., \textbf{Kumar, T.}, Panagopoulos, C., Peyton, K., Ravanilla, N., and Sierra-Ar\'{e}valo, M.  ``Organizational identity and positionality in randomized control trials: considerations and advice for collaborative research teams.'' Accepted, \textbf{\textit{PS: Political Science and Politics}}
...
\begin{itemize}
	\item[]\textit{Housing as welfare: how government-supported homeownership  redistributes wealth, creates dignity, and forms local-level interest groups in urban India}. Manuscript in preparation.
...
\begin{itemize}
		...
		\item[]``Why we should study smaller cities'' (with Matthew Stenberg). Submitted.		
...
\color{Black}
\begin{itemize}[nosep]
\item[] Susan Clarke Young Scholar  -- APSA Urban and Local Politics Section, 2021
	\item[] Best Dissertation (Honorable Mention) --  APSA Urban and Local Politics Section, 2021
...
\color{Black}
\begin{itemize}
\item[]Women's Economic Empowerment and Digital Finance Initiative, BRAC  (with Peter Carroll, Boniface Dulani, Philip Roessler, and Daniel Nielson)
 -- 46,337.59 USD, 2021 
...
\color{Black}
\begin{itemize}
\item[] \textbf{2022}: Complex Governance Seminar (American University), Housing Politics and Policy Conference (Princeton University)
...
\item[] Excellence in Mentoring Award Committee, APSA Public Policy Section, 2022

\item[]Journal referee service: \textit{American Journal of Political Science}, \textit{American Political Science Review}, \textit{Journal of Policy Analysis and Management}, \textit{PLOS ONE}, \textit{PS: Political Science}, \textit{Urban Affairs Review}, \textit{World Politics}
