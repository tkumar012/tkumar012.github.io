...
\begin{itemize}
	...
	\item[]``Cooperation among elected officials and its effects on local-level responsiveness in Mumbai''
...
\item[]Affiliations: Visions in Methodology, GlobalWonks, Berkeley Initiative for Transparency in the Social Sciences
\end{itemize}
