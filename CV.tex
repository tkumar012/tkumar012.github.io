...
\begin{itemize}
	...
	\item[]``Dignity, status, and participation: cooperative welfare in  India''
	\end{itemize}
\vspace{1mm}
\section*{OTHER WRITING}
\begin{itemize}
\item[]``Household level effects of affordable housing: Evidence from Mumbai.'' \textit{Ideas for India}, September 2, 2019.
