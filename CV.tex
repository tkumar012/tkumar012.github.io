...
\begin{itemize}
	...
	\item[]``The intergenerational effects of subsidizing homeownership: evidence from a program in Mumbai'' 		\item[]``From public service access to service quality: The distributive politics of piped water in Bangalore'' with Alison Post, Megan Otsuka, Francesc Pardo-Bosch, and Isha Ray 
...
\begin{itemize}
\item[]\href{https://www.ideasforindia.in/topics/poverty-inequality/household-level-effects-of-affordable-housing-evidence-from-mumbai.html}{``Household level effects of affordable housing: Evidence from Mumbai.''} \textit{Ideas for India}, September 4, 2019.
