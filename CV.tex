...
&Center for Effective Global Action Faculty Affiliate, UC Berkeley \hfill 2022-\\
...
& Book manuscript: \textit{Housing as welfare: how subsidized homeownership generates social mobility through wealth, dignity, and voice in India.} In progress, workshop scheduled for Spring 2023. Chapters available upon request.\\ 
& \\



&\href{https://tanukumar.com/complaintsresponsiveness.pdf}{``How the content of complaints shapes government responsiveness: theory and evidence from Mumbai.''} Working paper, submitted. \\
& \\
& ``The politics of citizen-led expansion and informality at the edges of India’s cities.'' with A. Auerbach. Working paper, available upon request.\\
& \\

&``When do local governments improve transparency? 
Special districts outpace cities and counties in California transit'' with I. Ratan, A. Post, and M. Sheth. Working paper, available upon request.\\
...
&``An experimental analysis of the impact of smartphones and household property rights on the uptake of digital financial services.'' with P. Roessler, P. Carroll, B. Dulani, and D. Nielson. Midline data collected.\\
& \\
&``Ad-supported smartphones to bridge the digital gender gap.'' with P. Roessler and E. Agasha. Seed funding acquired, initial piloting complete. \\
& \\
&``Voice and response: What motivates bureaucratic responsiveness to citizen voice?'' with G. Kruks-Wisner. Funding acquired. Qualitative data collection and scoping in progress.\\
...
Policy Writing &
\href{https://urbanaffairsreview.com/2022/10/11/why-political-scientists-should-study-smaller-cities/}{``Why Political Scientists Should Study Smaller Cities''} with M. Stenberg. \textit{Urban Affairs Forum}, 2022.\\
& \\
...
&\\
& \textbf{2022}\\
     &Keough School of Global Affairs, University of Notre Dame (rescheduled)\\
...
&Economic Development: Household \& Local Development Issues (Development Economics), Spring 2023\\
...
&Peer Review: \textit{American Journal of Political Science}, \textit{American Political Science Review}, BRAC Institute of Governance and Development Grants, \textit{Journal of Policy Analysis and Management}, \textit{Journal of Urban Economics}, Oxford University Press, \textit{PLOS ONE}, \textit{PS: Political Science}, \textit{Urban Affairs Review}, \textit{World Politics}, \textit{Social Policy \& Administration}\\ 
&\\
