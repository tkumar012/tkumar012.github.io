...
\begin{itemize}
	...
	\item[]``The intergenerational effects of subsidizing homeownership: evidence from a program in Mumbai''*
	\begin{itemize}
	\item[]*Companion papers featured in \textit{The Print}, \textit{Ideas for India}, and \textit{The Monkey Cage}
	\end{itemize} 	
