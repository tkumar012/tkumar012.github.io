...
& Governance Specialist, Institutions, Capacity and Effectiveness\hfill  2025-\\& \\
...
Book & \textbf{Kumar, T.},  \textit{Building social mobility: how subsidized homeownership creates wealth, dignity, and voice in India.}  Cambridge University Press (Cambridge Studies in Comparative Politics), 2025.\\
&--\indent  Frankel Award for the best book in South Asian politics in the last two years, 2026\\
& \\

\nohyphens{{Articles}} 

&``Democratizing bureaucracy: How can citizens demand accountability from unelected officials?'' w/ G. Kruks-Wisner. Accepted, \textit{World Politics}.\\



&--\indent  Best paper award in class \& inequality, APSA 2025\\
& \\
& A. Auerbach and \textbf{Kumar, T.} \href{https://doi.org/10.1080/00220388.2025.2521492}{``Politics in the urban periphery: Citizen-led expansion and informality at the edges of India's cities.''} \textit{Journal of Development Studies}, 2025.\\
& \\

& I. Ratan, A. Post, \textbf{Kumar, T.}, and M. Sheth.\href{https://journals.sagepub.com/doi/full/10.1177/10780874251357506}{``When do local governments improve transparency? 
Bureaucratic champions for open transit data in California''}  \textit{Urban Affairs Review}, 2025.\\
...
&``Institutional capacity for policy implementation: an analytical framework'' w/ G. Kim, R. Ramalho, and S. Russell. \href{https://documents.worldbank.org/en/publication/documents-reports/documentdetail/099635001072670597}{World Bank policy research working paper}.\\
& \\
&``(Un)Willing Partners? Citizen-bureaucrat collaboration in capacity-constrained settings'' w/ G. Kruks-Wisner and D. Saunik. \textit{Under review.} \\
& \\
...
{{Honors}} 
& Frankel Best Book Award -- APSA South Asian Politics Section, 2026\\
...
{{Research Grants}} 
& \textbf{External}\\
& Coefficient Giving (w/ D. Rogger), 2026 \hfill \$2,000,000\\
...
&Bowdoin College, Department of Government, 2025\\
...
\textit{Journal of Policy Analysis and Management}, \textit{Journal of Politics}, \textit{Journal of Public Administration Research and Theory}, \textit{Journal of Urban Economics}, \textit{Local Government Studies}, Oxford University Press, \textit{PLOS ONE}, \textit{PS: Political Science}, Routledge Books, \textit{Urban Affairs Review}, \textit{World Politics}, \textit{Social Policy \& Administration}, \textit{Studies in Comparative International Development}\\ 
&\\
