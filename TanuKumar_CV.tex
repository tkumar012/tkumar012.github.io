...
& A. Auerbach and \textbf{Kumar, T.} \href{https://gld.gu.se/media/2985/gld_workingpaper_63_auerbachkumar_202303.pdf}{``Politics in the urban periphery: Citizen-led expansion and informality at the edges of India's cities.''} Forthcoming, \textit{Journal of Development Studies}.\\
& \\

&I. Ratan, A. Post, \textbf{Kumar, T.}, and M. Sheth.``When do local governments improve transparency? 
Bureaucratic champions for open transit data in California''  Conditional acceptance, \textit{Urban Affairs Review}.\\
